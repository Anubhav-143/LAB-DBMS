# Experiment 3 – SELECT with Sorting, Pattern Matching, and Filtering
...
### 2. List job and department number of employees whose name is five letters long, begins with "A" and ends with "N"
...
### 5. Display the names of employees working in department 10, 20 or 40, or employees working as clerks, salesman or analyst
...
### 10. Display the names of employees working as clerk, salesman or analyst and drawing a salary more than 3000
